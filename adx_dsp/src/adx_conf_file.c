...
int adx_conf_file_add(adx_list_t *cf, char *section, char *key, char *value)
{
...
int adx_conf_file_parse(adx_list_t *cf, const char *path)
{
...
{
    adx_list_t *cf = je_malloc(sizeof(adx_list_t));
    if (!cf) return NULL;
