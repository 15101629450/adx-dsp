        ...
        adx_cache_t *parent_cache)
{
    ...
    adx_cache_from_json_string(cache, adx_json_find(json, "monitorcode"));
    adx_cache_from_json_array(cache, adx_json_find(json, "imonitorurl"));
    adx_cache_from_json_array(cache, adx_json_find(json, "cmonitorurl"));
    adx_cache_from_json_string(cache, adx_json_find(json, "curl"));
    adx_cache_from_json_string(cache, adx_json_find(json, "landingurl"));
    adx_cache_from_json_string(cache, adx_json_find(json, "deeplink"));
    return cache;
}
...
void adx_dump_sort(adx_cache_t *adx_root)
{
    adx_list_t *p = NULL;
    adx_list_for_each(p, &adx_root->child_list) {
